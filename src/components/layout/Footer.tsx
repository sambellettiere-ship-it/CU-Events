        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/events?category=arts-culture" className="hover:text-white transition-colors">Arts & Culture</Link></li>
              <li><Link href="/events?category=food-drink" className="hover:text-white transition-colors">Food & Drink</Link></li>
              <li><Link href="/map" className="hover:text-white transition-colors">Event Map</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-semibold text-sm mb-3">Businesses</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/auth/register" className="hover:text-white transition-colors">List Your Events</Link></li>
              <li><Link href="/auth/login" className="hover:text-white transition-colors">Business Login</Link></li>
              <li><Link href="/dashboard" className="hover:text-white transition-colors">Dashboard</Link></li>
              <li><Link href="/dashboard/billing" className="hover:text-white transition-colors">Sponsored Listings</Link></li>
            </ul>
          </div>
        </div>
